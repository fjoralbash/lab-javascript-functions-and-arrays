...
// Iteration #3.1 Bonus:
elements = [true, 'hello', NaN , 1, 54, 33, 'what']
...
//}
//averagewordlength = wordlengthsum/wordsArr.length;
  averagewordlength = (sum(wordsArr) / wordsArr.length);
...
function avg(wordsArr) {
  ...
  const avgValue = (sum(wordsArr) / wordsArr.length);
